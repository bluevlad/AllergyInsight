...
│  pharmacist     │ 약사 (약물 상호작용, 대체 식품 조회)        │
...
| 기능 | super_admin | doctor | nurse | lab_tech | pharmacist | patient |
|------|-------------|--------|-------|----------|------------|---------|
| 환자 등록 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |
| 키트 결과 입력 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |
| 처방 작성 | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |
...
| 주차 | 작업 내용 |
|------|----------|
| 1주 | 데이터베이스 스키마 확장, 역할 시스템 구현 |
| 2주 | 의료진 인증 시스템, 환자 관리 API |
| 3주 | 처방 작성 API, 권한 시스템 |
| 4주 | 감사 로그, 보안 강화 |
...
| 주차 | 작업 내용 |
|------|----------|
| 5주 | 처방 엔진 고도화 (약물, 검사 권고) |
| 6주 | CDS 기능 (상호작용, 경고) |
| 7주 | 보고서 생성 (PDF, 환자 가이드) |
| 8주 | 논문 근거 시스템 강화 |
