...
- [ ] 기존 doctor_notes 필드 활용 UI 강화
- [ ] 소견 입력/수정 기능 개선

### Phase 3: 논문 시스템 고도화 (중기)
...
### Phase 4: 확장 (장기 - 고객 요구 시)

- [ ] SOAP Note 기반 임상 노트 기능
- [ ] 치료 프로토콜 템플릿 시스템
- [ ] 다국어 지원 확장
...
| 1.1 | 2025-01-27 | Phase 재정리 - SOAP/치료프로토콜 장기로 이동, PDF/ICD-10/의사소견 단기 집중 |
