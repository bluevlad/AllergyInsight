...
### Phase 4: 확장 및 연동 (장기 목표)

- [ ] 검사 결과 자동 연동
  - 방식 1: 검사결과 DB에서 결과정보 import batch job
  - 방식 2: 입력 API 제공하여 LIS/검사장비에서 자동 등록
- [ ] 다국어 지원 (영어)
- [ ] 결제/구독 시스템 (B2B 과금) - 고객사 확보 후 진행
...
| 2025-01-27 | 1.3 | Phase 3-4 재정리, EMR 연동 제외, 검사 연동 방식 구체화 |
